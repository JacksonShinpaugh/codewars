...
function isValidWalk(walk) {   
   const north = walk.filter(element => element === "n").length
   const south = walk.filter(element => element === "s").length
   const east = walk.filter(element => element === "e").length
   const west = walk.filter(element => element === "w").length
