...
// It should remove all values from list a, which are present in list b. Each element x in both arrays is 
// integer and 0 ≤ x ≤ 25. And lengths of arrays can reach 5 000 000 elements.
